...
export class PublicationCommandController {
  ...
  @GrpcMethod(
    GRPC_SERVICES.PUBLICATION_COMMAND_SERVICE,
    PUBLICATION_METHODS.CREATE_POST_NODE,
  )
  async createPostNode(
    data: CreateSocialPostCommandDTO,
  ...
  @GrpcMethod(
    GRPC_SERVICES.PUBLICATION_COMMAND_SERVICE,
    PUBLICATION_METHODS.DELETE_POST_NODE,
  )
  async deletePostNode(
    data: DeleteSocialPostCommandDTO,
  ...
  @GrpcMethod(
    GRPC_SERVICES.PUBLICATION_COMMAND_SERVICE,
    PUBLICATION_METHODS.POST_USER_OWN,
  )
  async postUserOwn(
  ...
  @GrpcMethod(
    GRPC_SERVICES.PUBLICATION_COMMAND_SERVICE,
    PUBLICATION_METHODS.DELETE_USER_OWN,
  )
  async deleteUserOwn(
    ...
    const { userId, postId } =
      PublicationMapper.toDisownPostCommandParams(data);
