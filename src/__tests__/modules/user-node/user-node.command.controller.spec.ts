...
import { UserNodeCommandController } from '../../../modules/user-node/controllers/user-node.command.controller';
...
} from '../../../modules/user-node/dto/user-node.response.dto';
...
describe('UserNodeCommandController', () => {
  ...
  describe('createUserNode', () => {
    ...
    it('should throw error if service fails', async () => {
      const dto: CreateSocialUserCommandDTO = { userId: 'user-123' };
      (service.createUser as jest.Mock).mockRejectedValueOnce(new Error('Database error'));
  ...
  describe('deleteUserNode', () => {
    ...
    it('should throw error if service fails', async () => {
      const dto: DeleteSocialUserCommandDTO = { userId: 'user-123' };
      (service.deleteUser as jest.Mock).mockRejectedValueOnce(new Error('User not found'));
